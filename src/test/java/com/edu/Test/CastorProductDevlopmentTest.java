...
public class CastorProductDevlopmentTest {
	...
	String activityName;
	String productID;
	String dataFile = "SIT_TestDataQA.yml";
	...
	public void TC002_CreateProductDevelopment() {
		test.castorHome.ClickOnProductDevlopment();
	...
	public void TC019_DisconnectAppearanceAndConnectApperancesAndSaveHeader() {
		...
		//test.merchantProductDevelopment.switchToContentFrame();
	...
	public void TC058_chooseHandoverTillGPOOMerch() {
	 ...
	 */
	@Test(dependsOnMethods = "TC058_chooseHandoverTillGPOOMerch")
